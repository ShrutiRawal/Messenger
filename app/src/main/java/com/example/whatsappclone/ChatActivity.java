...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mChatMessagesDb = FirebaseDatabase.getInstance().getReference().child("chat").child(chatID);
       ...
       // mMessage = findViewById(R.id.messageInput);
        //if(!mMessage.getText().toString().isEmpty()){
          //  String messageID = FirebaseDatabase.getInstance().getReference().child("chat").child(chatID).push().getKey();
            ...
            //ALREADYnewMessageDb.updateChildren(newMessageMap);
        ...
        //mMessage.setText(null);
            //ALREADYnewMessageMap.put("text", mMessage.getText().toString());
